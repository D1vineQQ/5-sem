...
int main() {
    ...
    HANDLE
        Child_1_Thread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)OS04_05_T1, NULL, 0, &Child_1_ID),
        Child_2_Thread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)OS04_05_T2, NULL, 0, &Child_2_ID);
    ...
    for (int i = 0; i <= 100; i++)
    {
        ...
        switch (i) {
        case 40:
            TerminateThread(Child_2_Thread, -1);
            cout << "Child 2 Termnated\n";
            break;
        }
    }
