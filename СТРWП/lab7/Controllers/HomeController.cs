...
{
    private const string AccessKey = "23052005";
    ...
    public IActionResult Index(string filterKeyword)
    {
        ...
        var mode = HttpContext.Session.GetString(SessionKey) ?? "guest";  // Определение режима пользователя
        ViewBag.Mode = mode;
    ...
    public IActionResult AddComment(int linkId, string commentText)
    {
        ...
        var newComment = new CommentModel
        {
            ...
            SessionId = HttpContext.Session.GetString(SessionKey) ?? "guest", // Сохраняем SessionId
